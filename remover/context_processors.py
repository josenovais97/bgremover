...
OG_IMAGES = {
    # Generated by scripts/make-og-cards.py — one card per tool, carrying its own
    # name, blurb, artwork and accent. Re-run that script after renaming a tool or
    # changing its demo image. `index` is absent on purpose: the homepage keeps the
    # purpose-built site-wide og-image.png.
    "convert": "img/og/convert.png",
    "compress": "img/og/compress.png",
    "resize": "img/og/resize.png",
    "instagram": "img/og/instagram.png",
    "crop": "img/og/crop.png",
    "sticker": "img/og/sticker.png",
    "text_behind": "img/og/text-behind.png",
    "watermark": "img/og/watermark.png",
    "gif": "img/og/gif.png",
    "video_gif": "img/og/video-gif.png",
    "video_converter": "img/og/video-converter.png",
    "meme": "img/og/meme.png",
    "passport": "img/og/passport.png",
    "ecommerce": "img/og/ecommerce.png",
    "blur": "img/og/blur.png",
    "redact": "img/og/redact.png",
    "favicon": "img/og/favicon.png",
    "qr": "img/og/qr.png",
    "exif": "img/og/exif.png",
    "pdf": "img/og/pdf.png",
    "screenshot": "img/og/screenshot.png",
    "collage": "img/og/collage.png",
    "border": "img/og/border.png",
    "palette": "img/og/palette.png",
    "base64": "img/og/base64.png",
    ...
    "word_to_pdf": "img/og/word-to-pdf.png",
    "pdf_to_word": "img/og/pdf-to-word.png",
    "pdf_tools": "img/og/pdf-tools.png",
    "csv_excel": "img/og/csv-excel.png",
    "ocr": "img/og/ocr.png",
